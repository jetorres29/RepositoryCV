...
pruebah<-gvlma::gvlma(lm(y.all ~ x23+x25+x31,data=data.frame(y.all,x.all)))
pruebah
par(mar=rep(2,4)) #debe repetir 4
plot(pruebah)      # Residuals, Fitted, ...
